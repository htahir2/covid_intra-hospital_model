...
class IntraHospModel(Model):
    ...
    results_dir = '/scratch/HT1301/ppe_090_new_strain_sens_high/cont_trac_7_perf_sens/'
#    results_dir = '/Users/hannantahir/Documents/mesa/COVID19/covid19_lisa/final_simulations/Final_simulations_20210204/ppe_090_new_strain_sens_high/cont_trac_7_perf_sens/'
                            ...
                            if hcw1.unique_id == val[0]: ## check if id of hcws match with the individuals contacts
                                ...
                                if (self.schedule.time - val[1])>=params.testing_day_simtime:
                                    ...
                                    if (hcw1.state == State.EXPOSED or hcw1.state == State.ASYMPTOMATIC):
                                        ...
                                        test_prob = self.test_sensitivity['detection_prob_stays_high'].loc[infec_time_in_steps]                                        
