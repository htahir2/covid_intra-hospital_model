...
class IntraHospModel(Model):
    ...
    results_dir = '/scratch/HT1301/ppe_090_new_strain_30min_contact_hcws/cont_trac_7_perf_sens/'
#    results_dir = '/Users/hannantahir/Documents/mesa/COVID19/covid19_lisa/final_simulations/Final_simulations_20210204/ppe_090_new_strain_30min_contact_hcws/cont_trac_7_perf_sens/'
...
#        ## functions that are called once every day, at the start of the day.
        ...
        if self.schedule.time%(self.num_steps_per_day/48) == 0: ## functions that are called every hour
