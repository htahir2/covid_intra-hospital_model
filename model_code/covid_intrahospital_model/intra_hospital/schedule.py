...
class RandomActivationByType(RandomActivation):
    ...
    def add(self, agent):
        ...
        self.agents_by_type[agent_class].append(agent) ## add agent by same type
    ...
    def remove(self, agent):
        ...
        while agent in self.agents_by_type[agent_class]:
            self.agents_by_type[agent_class].remove(agent) ## remove agent from list of same type
    ...
    def step_type(self, type):
        ...
        random.shuffle(agents)              # unComment this if you want to shuffle agents activation.
        for agent in agents:
            agent.step()
