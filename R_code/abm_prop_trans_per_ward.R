...
transmission_wards <- read_excel_allsheets(paste0("../",dataPath, "Perc_transm_covid_and_non_covid_per_ward.xlsx"))
transm_data <- NULL
...
# ggsave(plot = ward_plot_with_error, file = paste0(figuresPath, "trans_per_ward_plot_with_error.pdf"),
#       width=12, height=9)
...
# ward_plot  
ggsave(plot = ward_plot, file = paste0(figuresPath, "trans_per_ward_plot.pdf"),width=12, height=9)
